...
export function analyzeDeal(
  ...
  const partial: DealAnalysis = {
    ...
    peReturns: {
      ...
      bear: { label: "Bear", rows: [], exitEnterpriseValue: 0, exitDebtPayoff: 0, exitGrossEquityProceeds: 0, exitCapitalGainsTax: 0, exitEquityProceeds: 0, totalEquityIn: 0, totalDistributions: 0, irr: null, moic: null, rationale: "" },
      base: { label: "Base", rows: [], exitEnterpriseValue: 0, exitDebtPayoff: 0, exitGrossEquityProceeds: 0, exitCapitalGainsTax: 0, exitEquityProceeds: 0, totalEquityIn: 0, totalDistributions: 0, irr: null, moic: null, rationale: "" },
      bull: { label: "Bull", rows: [], exitEnterpriseValue: 0, exitDebtPayoff: 0, exitGrossEquityProceeds: 0, exitCapitalGainsTax: 0, exitEquityProceeds: 0, totalEquityIn: 0, totalDistributions: 0, irr: null, moic: null, rationale: "" },
